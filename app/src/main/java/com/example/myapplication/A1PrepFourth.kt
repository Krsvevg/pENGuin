...
class A1PrepFourth : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a1_prep_fourth)
        ...
        answerInput.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                val isCorrectAnswer = s?.toString()?.equals("under", ignoreCase = true) ?: false
                ...
                if (isCorrectAnswer) {
                    continueButton.setOnClickListener {
                        ...
                        val intent = Intent(this@A1PrepFourth, A1PrepFifth::class.java)
