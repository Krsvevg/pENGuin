...
class A2PSTenth : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a2_pstenth)
        ...
        answerInput.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                val isCorrectAnswer = s?.toString()?.equals("Did", ignoreCase = true) ?: false
                ...
                if (isCorrectAnswer) {
                    continueButton.setOnClickListener {
                        ...
                        val intent = Intent(this@A2PSTenth, A2List::class.java)
