...
import com.example.myapplication.A2FutFirst
import android.content.SharedPreferences

class B1PPPSFirst : AppCompatActivity() {
    private lateinit var sharedPreferences: SharedPreferences
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_b1_pppsfirst)
        ...
        if (sharedPreferences.getBoolean("B1PPPSFirst_completed", false)) {
