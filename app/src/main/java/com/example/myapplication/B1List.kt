...
class B1List : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firstBlock.setOnClickListener {
            val intent = Intent(this, B1PPPSFirst::class.java)
            startActivity(intent)
        }
        secondBlock.setOnClickListener {
            val intent = Intent(this, B1PVFirst::class.java)
            startActivity(intent)
        }
        thirdBlock.setOnClickListener {
            val intent = Intent(this, B1SCFirst::class.java)
            startActivity(intent)
        }
        fourthBlock.setOnClickListener {
            val intent = Intent(this, B1RSFirst::class.java)
            startActivity(intent)
        }
        fifthBlock.setOnClickListener {
            val intent = Intent(this, B1PVerbsFirst::class.java)
            startActivity(intent)
        }
    }
}