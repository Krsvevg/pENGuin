...
import com.example.myapplication.A1VocFirst

class A1ThereFirst : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a1_there_first)
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                if (isCorrectAnswer) {
                    continueButton.setOnClickListener {
                        ...
                        val intent = Intent(this@A1ThereFirst, A1ThereSecond::class.java)
