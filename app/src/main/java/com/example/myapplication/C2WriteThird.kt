...
class C2WriteThird : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_c2_write_third)
        ...
        val option2Button = findViewById<Button>(R.id.option1Button)
        val option1Button = findViewById<Button>(R.id.option2Button)
        ...
        option1Button.setOnClickListener {
            ...
            val intent = Intent(this, C2WriteFourth::class.java)
