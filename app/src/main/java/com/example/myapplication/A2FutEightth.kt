...
class A2FutEightth : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a2_fut_eightth)
        ...
        answerInput.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                val isCorrectAnswer = s?.toString()?.equals("won’t be", ignoreCase = true) ?: false
                ...
                if (isCorrectAnswer) {
                    continueButton.setOnClickListener {
                        ...
                        val intent = Intent(this@A2FutEightth, A2FutNineth::class.java)
