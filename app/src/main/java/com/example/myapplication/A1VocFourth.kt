...
class A1VocFourth : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a1_voc_fourth)
        ...
        answerInput.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                val isCorrectAnswer = s?.toString()?.equals("granddaughter", ignoreCase = true) ?: false
                ...
                if (isCorrectAnswer) {
                    continueButton.setOnClickListener {
                        ...
                        val intent = Intent(this@A1VocFourth, A1VocFifth::class.java)
