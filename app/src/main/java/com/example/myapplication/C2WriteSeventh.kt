...
class C2WriteSeventh : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_c2_write_seventh)
        ...
        val option3Button = findViewById<Button>(R.id.option1Button)
        val option2Button = findViewById<Button>(R.id.option2Button)
        val option1Button = findViewById<Button>(R.id.option3Button)
        //Правильный ответ
        option1Button.setOnClickListener {

            option1Button.setBackgroundColor(Color.parseColor("#3366FF"))
            option1Button.setTextColor(Color.WHITE)

            // Переход на следующий экран (замените MainActivity3 на ваш следующий экран)
            val intent = Intent(this, C2WriteEightth::class.java)
